...
def load_cbramod():
    ...
    print(f"Loaded pretrained weights from {weights_path}, missing keys: {missing_keys}, unexpected keys: {unexpected_keys}")
...
def main():
    ...
    # Load CBraMod
    cbramod_success = load_cbramod()
    
    # Load BrainLM
    brainlm_success = load_brainlm()
    print("End of main")
